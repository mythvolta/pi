...
// There is one button, one fan, up to two LEDs, and an IR receiver
...
#define GPIO_LED    18   // The first LED is connected to GPIO18 (pin 12, WPi 1) in ALT5 mode for PWM
