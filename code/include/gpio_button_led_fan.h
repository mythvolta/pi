...
#define GPIO_BTN    27   // Button A is connected to GPIO27 (pin 13/gnd 14, WPi 2)
#define GPIO_FAN    23   // The fan is connected to GPIO24 (pin 16/gnd 14, WPi 4)
//#define GPIO_FAN    24   // The fan is connected to GPIO24 (pin 18/gnd 20, WPi 4)
